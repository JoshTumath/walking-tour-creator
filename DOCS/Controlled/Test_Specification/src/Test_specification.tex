...
& Warning if the user really wants to cancel the walk \\ \hline
...
& Button Press Event
& Pop up warning
& Warning telling the user they need a point of interest to upload \\ \hline
...
& Button Press Event
& Pop up warning
& Warning telling the user they can not upload at this time and return to walk screen\\ \hline
...
& Physical interaction with phone
& Different Screen orientation
& Different Screen orientation with the same data before screen rotation on every screen\\ \hline
